...
public class CardValidator {
    ...
    public boolean validateCardData(Transfer transfer) {
        String cardFromNumber = transfer.cardFromNumber();
    ...
    public boolean validateDateAndCvv(Transfer transfer, Card validCardFrom) {
        boolean validTillIsCorrect = Objects.equals(validCardFrom.getValidTill(), transfer.cardFromValidTill());
        boolean cvvIsCorrect = Objects.equals(validCardFrom.getCvv(), transfer.cardFromCVV());
